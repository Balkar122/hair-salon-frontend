...
export const services = [
  { id: 1, title: 'Hair Cut', price: '₹250', duration: '45 min', image: heroImage, description: 'Precision cuts tailored to your face shape and style.' },
  { id: 2, title: 'Hair Styling', price: '₹400', duration: '60 min', image: heroImage, description: 'Elegant blowouts and styling for every occasion.' },
  { id: 3, title: 'Hair Coloring', price: '₹900', duration: '120 min', image: heroImage, description: 'Premium color treatments with expert blending.' },
  { id: 4, title: 'Hair Spa', price: '₹550', duration: '50 min', image: heroImage, description: 'Deep nourishment and relaxation for healthy hair.' },
  { id: 5, title: 'Keratin', price: '₹1200', duration: '150 min', image: heroImage, description: 'Smooth, frizz-free finish with luxury keratin treatment.' },
  { id: 6, title: 'Facial', price: '₹600', duration: '60 min', image: heroImage, description: 'Rejuvenating skincare tailored to your skin type.' },
  { id: 7, title: 'Beard Styling', price: '₹200', duration: '30 min', image: heroImage, description: 'Sharp beard shaping and grooming services.' },
  { id: 8, title: 'Bridal Makeup', price: '₹1800', duration: '180 min', image: heroImage, description: 'Luxury bridal beauty package for your special day.' },
]
